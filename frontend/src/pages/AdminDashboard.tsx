...
function Kpi({
  ...
  return (
    <div className={`role-kpi admin-kpi-card ${tone}`}>
      <span
        className={`role-kpi-icon ${tone}`}
      >
        <Icon
          name={icon}
          size={24}
...
export function AdminDashboard() {
  ...
  return (
    <div className="role-dashboard admin-role-dashboard">
      ...
      <section className="admin-analytics-grid">
        ...
        <div className="role-panel">
          <div className="role-trend-header">
            <h3>
              User Trend
              (Last 6 Months)
            </h3>

            <div className="role-chart-legend">
              <span>
                <i className="light" />
                New Users
              </span>
        ...
        <div className="role-panel admin-activity">
      ...
      <section className="admin-bottom-grid">
        <div className="role-panel compact-table">
          <div className="role-panel-head">
            <h3>
              Recent Users
            </h3>
